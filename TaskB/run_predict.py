...
def main():
    ...
    file_name = '/home/sanala/Juputer try/final_EDOS/TaskB/'+'dev_task_b.csv'
    text_column = 'text'
    ...
    target_names = ['2. derogation', '1. threats, plans to harm and incitement','3. animosity','4. prejudiced discussions']
    ...
    f = open("/home/sanala/Juputer try/final_EDOS/TaskB/output/"+args.results_dir, 'a')
