...
def main():
    ...
    #train = pd.read_csv(data_dir+'TaskB/train_dev_task_b.csv', header=0)
    #train = pd.read_csv(data_dir+'TaskB/train_task_b.csv', header=0)
    train = pd.read_csv(data_dir+'TaskB/train_aug100.csv', header=0)
    ...
    if not do_eval:
        ...
        #train = pd.read_csv(data_dir+'TaskB/train_dev_task_b.csv')
        #train = pd.read_csv(data_dir+'TaskB/train_task_b.csv', header=0)
        train = pd.read_csv(data_dir+'TaskB/train_aug100.csv', header=0)
        train=preprocess_pandas(train, list(train.columns))
    ...
    valid = pd.read_csv(data_dir+'TaskB/dev_task_b.csv')
    train = train.dropna()
    train = train.dropna()
    ...
    for i in range (1):
        ...
        trainer=Trainer(model,args=training_arg,train_dataset=tokenized_datasets_train,
                        eval_dataset=None, #tokenized_datasets_valid, #None,
